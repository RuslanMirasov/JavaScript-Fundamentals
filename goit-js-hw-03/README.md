...
- Виклик slugify("Ten secrets of JavaScript") повертає
...
- Виклик makeArray(["Mango", "Poly"], ["Ajax", "Chelsea"], 3) повертає ["Mango",
  "Poly", "Ajax"]
...
- Виклик makeArray(["Earth", "Jupiter"], ["Neptune", "Uranus"], 2) повертає
  ["Earth", "Jupiter"]
- Виклик makeArray(["Earth", "Jupiter"], ["Neptune", "Uranus"], 4) повертає
...
- Виклик функції filterArray() з випадковим масивом і числом повертає правильний
  масив
