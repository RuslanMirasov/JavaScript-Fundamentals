...
- Виклик isEnoughCapacity({ apples: 18, potatoes: 5, oranges: 2 }, 7) повертає
  false
...
- Метод **changeUsername(newName)** повинен приймати рядок (нове ім’я) в
  параметр newName та змінювати значення властивості username на нове. Нічого не
  повертає.
- Метод **updatePlayTime(hours)** повинен приймати число (кількість годин) у
  ...
  повертає.
- Метод **getInfo()** має повертати рядок формату &lt;Username&gt; has
  &lt;amount&gt; active hours!, де &lt;Username&gt; — це ім’я профілю, а
